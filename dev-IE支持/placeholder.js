...
$.holder = {
    ...
    fix: function () {
        $(':input[placeholder]').each(function (index, element) {
            ...
            var holder = $('<p></p>').text(txt).css({ position: 'absolute', left: pos.left, top: pos.top, height: h+"px", lineHeight: h+"px", paddingLeft: paddingleft, paddingTop: paddingTop, paddingBottom: paddingBottom, color: '#aaa', borderTop: borderTop+" solid transparent" }).appendTo(self.parent());
