...
!(function () {
    ...
    */
    function Dialog(json) {
        var obj = {
            ...
            Init: function (json) {
                ...
                //2.标题和关闭按钮层
                this.oTitle = this.D($.createNode('h2', { 'data-dialog': 'title' }, this.title));
    ...
    $.sheet({
        ...
        '[data-dialog="close"]': 'position: absolute; right: 0; top: 0; width: 50px; height: 50px; margin-top: -1px; margin-right: -1px; background: url(/css/images/dialog-close.png) center center no-repeat; cursor: pointer;',
        '[data-dialog="close"]:hover': 'background-image: url(/css/images/dialog-close-hover.png);',
