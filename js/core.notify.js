...
!(function ($) {
    $.notify =
        {
            template: '<div class="notify"><div class="loading-body"><img class="loading-icon" src="http://2017.ui.jiayou.com/css/images/loading.gif"/><div class="loading-text"></div></div></div>',
            defaults: {
                selector: 'body',
                text: '加载中...',
                icon: '',
